...
namespace magmaHCWrapper {
        ...
        const magmaFloatComplex __restrict__ *d_phc_coeffs_Ht )
    {
        ...
        // -- 34 - 9*3 = 7 --
        // -- N_2 * 3 = 54 --
        // -- last s_phc_coeffs_Hx from the above for-loop: 9*3=27
        if (tx < 7) {
          s_phc_coeffs_Hx[ tx + 27 ] = d_phc_coeffs_Hx[ tx*2 + 54] 
                                     + d_phc_coeffs_Hx[ tx*2 + 1 + 54] * t;
        }
        ...
        // -- last s_phc_coeffs_Hx from the above for-loop: 9*3=27
        if (tx < 7) {
          s_phc_coeffs_Ht[ tx + 27 ] = d_phc_coeffs_Ht[ tx + 27 ];
        }
