#ifndef kernel_HC_Solver_katsura6_cu
#define kernel_HC_Solver_katsura6_cu
// ============================================================================
// homotopy continuation solver for katsura6 problem
//
// Modifications
//    Chien  21-12-09:   katsura6 benchmark problem; originally created
//
// ============================================================================
#include <stdio.h>
#include <stdlib.h>
...
namespace magmaHCWrapper {
  ...
  __global__ void
  homotopy_continuation_solver_katsura6(
    magma_int_t ldda,
  ...
  )
  {
    ...
    e = cudaLaunchKernel((void*)homotopy_continuation_solver_katsura6< 7, 3, 24, 5, 10, 63, 32, 3, 3, 8, 4>, grid, threads, kernel_args, shmem, my_queue->cuda_stream());

    gpu_time = magma_sync_wtime( my_queue ) - gpu_time;
    if( e != cudaSuccess ) {
        printf("cudaLaunchKernel of homotopy_continuation_solver_katsura6 is not successful!\n");
    }
