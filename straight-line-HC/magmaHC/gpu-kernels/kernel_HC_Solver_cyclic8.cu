...
namespace magmaHCWrapper {
  ...
  __global__ void
  homotopy_continuation_solver_cyclic8(
    magma_int_t ldda,
...
*/
  ...
  )
  {
    ...
    e = cudaLaunchKernel((void*)homotopy_continuation_solver_cyclic8< 8, 2, 24, 5, 10, 504, 80, 7, 9, 8, 10>, grid, threads, kernel_args, shmem, my_queue->cuda_stream());
