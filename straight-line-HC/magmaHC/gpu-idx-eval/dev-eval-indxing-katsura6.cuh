#ifndef dev_eval_indxing_katsura6_cuh_
#define dev_eval_indxing_katsura6_cuh_
// ============================================================================
...
namespace magmaHCWrapper {
        ...
        magmaFloatComplex r_startCoefs[coefsCount], magmaFloatComplex r_targetCoefs[coefsCount])
    {
        ...
        /*if (tx < 4) {
          s_vector_cdt[ tx + 40 ] = r_targetCoefs[tx + 40] * t - r_startCoefs[tx + 40] * (t-1);
        }*/
    }
    ...
    __device__ __inline__ void
    eval_Jacobian_katsura6_improve(
