#ifndef dev_eval_indxing_katsura20_cuh_
#define dev_eval_indxing_katsura20_cuh_
// ============================================================================
...
namespace magmaHCWrapper {
    ...
    __device__ __inline__ void
    eval_Jacobian_katsura20_improve(
    ...
    __device__ __inline__ void
    eval_Jacobian_katsura20_cached(
      const int tx,
      magmaFloatComplex *s_track, magmaFloatComplex r_cgesvA[N], 
