#ifndef dev_eval_indxing_katsura15_cuh_
#define dev_eval_indxing_katsura15_cuh_
// ============================================================================
...
namespace magmaHCWrapper {
    ...
    __device__ __inline__ void
    eval_Jacobian_katsura15_improve(
    ...
    __device__ __inline__ void
    eval_Jacobian_katsura15_cached(
      const int tx,
      magmaFloatComplex *s_track, magmaFloatComplex r_cgesvA[N], 
