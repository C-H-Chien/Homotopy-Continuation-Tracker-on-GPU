...
Eq1 = dot([t[1]; t[2]; 1], cross([x[1,2,:];1], R * [x[1,1,:];1]))
Eq2 = dot([t[1]; t[2]; 1], cross([x[2,2,:];1], R * [x[2,1,:];1]))
Eq3 = dot([t[1]; t[2]; 1], cross([x[3,2,:];1], R * [x[3,1,:];1]))
Eq4 = dot([t[1]; t[2]; 1], cross([x[4,2,:];1], R * [x[4,1,:];1]))
Eq5 = dot([t[1]; t[2]; 1], cross([x[5,2,:];1], R * [x[5,1,:];1]))
