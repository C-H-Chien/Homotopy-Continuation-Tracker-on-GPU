...
%  5-point relative pose estimation problem (Geometric form)
%
%> Code Description: 
%     Use synthetic curve datasets, generate the target parameters and the 
%     ground truth data. These data are then used by the 
%     evaluation_5pt_rel_pose_geometric.m function file for verifications.
%
...
evaluation_5pt_rel_pose_geometric(solutions, parameters', rotation_representation, 1e-8);
