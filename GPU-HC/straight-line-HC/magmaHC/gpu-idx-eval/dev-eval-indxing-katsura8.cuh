#ifndef dev_eval_indxing_katsura8_cuh_
#define dev_eval_indxing_katsura8_cuh_
// ============================================================================
// Device function for parallel evaluations of Hx, Ht, and H of
// katsura8 problem
//
// Modifications
//    Chien  21-12-16:   Originally created
//
// ============================================================================
#include <cstdio>
#include <iostream>
...
namespace magmaHCWrapper {
    ...
    __device__ __inline__ void
    eval_Jacobian_katsura8_improve(
