#ifndef cpu_hc_solver_katsura11_cpp
#define cpu_hc_solver_katsura11_cpp
// =======================================================================
// Solve homotopy continuation on cpu for the katsura11 problem
//
// Modifications
...
#include "../cpu-eval-HxHt/cpu-eval-HxHt-katsura11.h"
#include "../cpu-eval-HxH/cpu-eval-HxH-katsura11.h"
    ...
    for (magma_int_t s=0; s < batchCount; s++) {
      ...
      for(int step = 0; step <= max_steps; step++) {
        if (t0 < 1.0 && (1.0-t0 > 0.00001)) {
          ...
          // ===================================================================
          // -- get k1 HxHt --
          cpu_eval_HxHt_katsura11(s, t0, N, h_Track_cpu + s * N, C0, C1, h_startCoefs_p + s * coefsCount, h_targetCoefs_p + s * coefsCount, h_cgesvA + s * N * N, h_cgesvB + s * N );
          ...
          for(int c = 0; c < correction_iterations; c++) {
            ...
            cpu_eval_HxH_katsura11( s, t0, N, h_Track_cpu + s * N, C0, C1, h_startCoefs_p + s * coefsCount, h_targetCoefs_p + s * coefsCount, h_cgesvA + s * N * N, h_cgesvB + s * N );
