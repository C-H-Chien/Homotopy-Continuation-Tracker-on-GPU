#ifndef kernel_HC_Solver_alea6_cu
#define kernel_HC_Solver_alea6_cu
// ============================================================================
// homotopy continuation solver for alea6 problem
//
// Modifications
//    Chien  21-12-21:   alea6 benchmark problem; originally created
//
// ============================================================================
#include <stdio.h>
#include <stdlib.h>
...
// -- device function --
#include "../gpu-idx-eval/dev-eval-indxing-alea6.cuh"
...
namespace magmaHCWrapper {
  ...
  __global__ void
  homotopy_continuation_solver_alea6(
    magma_int_t ldda,
...
*/
  ...
  )
  {
    ...
    if( e != cudaSuccess ) {
        printf("cudaLaunchKernel of homotopy_continuation_solver_alea6 is not successful!\n");
    }
