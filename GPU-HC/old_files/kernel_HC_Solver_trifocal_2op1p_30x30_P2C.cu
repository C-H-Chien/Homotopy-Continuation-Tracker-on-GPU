...
// ===============================================================================================
// GPU-HC solver for Trifocal Relative Pose problem 30x30 (P2C Version)
//
// Modifications
//    Chien  24-03-24   Parameter to coefficients approach for evaluating Jacobian and Homotopy 
//
...
__global__ void
homotopy_continuation_solver_trifocal_2op1p_30_P2C (
  ...
  magma_int_t*          d_Hx_indices, 
  magma_int_t*          d_Ht_indices,
...
real_Double_t
kernel_HC_Solver_trifocal_2op1p_30x30_P2C(
...
)
{
  ...
  if (shmem <= shmem_max) {
    cudacheck( cudaFuncSetAttribute(homotopy_continuation_solver_trifocal_2op1p_30_P2C \
  ...
  e = cudaLaunchKernel((void*)homotopy_continuation_solver_trifocal_2op1p_30_P2C \
                        < num_of_vars, num_of_coeffs_from_params, max_order_of_t, \
                          dHdx_Max_Terms, dHdx_Max_Parts, dHdx_Entry_Offset, dHdx_Row_Offset, \
                          dHdt_Max_Terms, dHdt_Max_Parts, dHdt_Row_Offset, \
                          Full_Parallel_Offset, \
  ...
  if( e != cudaSuccess ) printf("cudaLaunchKernel of homotopy_continuation_solver_trifocal_2op1p_30_P2C is not successful!\n");
