#ifndef cpu_hc_solver_optimalPnP_w_quaternion_cpp
#define cpu_hc_solver_optimalPnP_w_quaternion_cpp
// =======================================================================
// Solve homotopy continuation on cpu for the optimal PnP with quaternion 
// problem
//
// Modifications
...
#include "../cpu-eval-HxHt/cpu-eval-HxHt-optimalPnP_w_quaternion.h"
#include "../cpu-eval-HxH/cpu-eval-HxH-optimalPnP_w_quaternion.h"
...
namespace magmaHCWrapper {
    ...
    magmaFloatComplex *h_track_numOfPred_s)
  {
    ...
    const magmaFloatComplex C3 = MAGMA_C_MAKE(4.0, 0.0);
    const magmaFloatComplex C4 = MAGMA_C_MAKE(8.0, 0.0);
    const magmaFloatComplex C5 = MAGMA_C_ZERO;
    ...
    for (magma_int_t s=0; s < batchCount; s++) {
      ...
      for(int step = 0; step <= max_steps; step++) {
        if (t0 < 1.0 && (1.0-t0 > 0.00001)) {
          ...
          // ===================================================================
          // -- get k1 HxHt --
          cpu_eval_HxHt_optimalPnP_w_quaternion(s, t0, N, h_Track_cpu + s * N, C0, C1, C2, C3, C4, C5, h_startCoefs_p + s * coefsCount, h_targetCoefs_p + s * coefsCount, h_cgesvA + s * N * N, h_cgesvB + s * N );
          ...
          for(int c = 0; c < correction_iterations; c++) {
            ...
            cpu_eval_HxH_optimalPnP_w_quaternion( s, t0, N, h_Track_cpu + s * N, C0, C1, C2, C3, C4, C5, h_startCoefs_p + s * coefsCount, h_targetCoefs_p + s * coefsCount, h_cgesvA + s * N * N, h_cgesvB + s * N );
          ...
          if (track_steps > max_success_steps)
            max_success_steps = track_steps;
          break;
        }
      }
    ...
    std::cout<<"max_success_steps: "<<max_success_steps<<std::endl;
