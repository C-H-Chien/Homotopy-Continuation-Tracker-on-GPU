#ifndef cpu_hc_solver_refractive_p5p_cpp
#define cpu_hc_solver_refractive_p5p_cpp
// =======================================================================
// Solve homotopy continuation on cpu for the refractive P5P problem
//
// Modifications
...
#include "../cpu-eval-HxHt/cpu-eval-HxHt-refractive_p5p.h"
#include "../cpu-eval-HxH/cpu-eval-HxH-refractive_p5p.h"
    ...
    for (magma_int_t s=0; s < batchCount; s++) {
      ...
      for(int step = 0; step <= max_steps; step++) {
        if (t0 < 1.0 && (1.0-t0 > 0.00001)) {
          ...
          // ===================================================================
          // -- get k1 HxHt --
          cpu_eval_HxHt_refractive_p5p(s, t0, N, h_Track_cpu + s * N, C0, C1, C2, h_startCoefs_p + s * coefsCount, h_targetCoefs_p + s * coefsCount, h_cgesvA + s * N * N, h_cgesvB + s * N );
          ...
          for(int c = 0; c < correction_iterations; c++) {
            ...
            cpu_eval_HxH_refractive_p5p( s, t0, N, h_Track_cpu + s * N, C0, C1, C2, h_startCoefs_p + s * coefsCount, h_targetCoefs_p + s * coefsCount, h_cgesvA + s * N * N, h_cgesvB + s * N );
