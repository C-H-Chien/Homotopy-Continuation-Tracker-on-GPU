#ifndef cpu_hc_solver_3view_unknownf_pHC_cpp
#define cpu_hc_solver_3view_unknownf_pHC_cpp
// =======================================================================
// Solve homotopy continuation on cpu for the 3 view triangulation problem
//
// Modifications
...
#include "../cpu-eval-HxHt/cpu-eval-HxHt-3view_unknownf_pHC.h"
#include "../cpu-eval-HxH/cpu-eval-HxH-3view_unknownf_pHC.h"
...
namespace magmaHCWrapper {
    ...
    magmaFloatComplex *h_track_numOfPred_s)
  {
    ...
    for (magma_int_t s=0; s < batchCount; s++) {
      ...
      for(int step = 0; step <= max_steps; step++) {
        if (t0 < 1.0 && (1.0-t0 > 0.00001)) {
          ...
          // ===================================================================
          // -- get k1 HxHt --
          cpu_eval_HxHt_3view_unknownf_pHC(s, t0, N, h_Track_cpu + s * N, C0, C1, C2, C3, h_startCoefs_p + s * coefsCount, h_targetCoefs_p + s * coefsCount, h_cgesvA + s * N * N, h_cgesvB + s * N );
          ...
          for(int c = 0; c < correction_iterations; c++) {
            ...
            cpu_eval_HxH_3view_unknownf_pHC( s, t0, N, h_Track_cpu + s * N, C0, C1, C2, C3, h_startCoefs_p + s * coefsCount, h_targetCoefs_p + s * coefsCount, h_cgesvA + s * N * N, h_cgesvB + s * N );
    ...
    std::cout<<"Number of max successful steps: "<<max_success_steps<<std::endl;
