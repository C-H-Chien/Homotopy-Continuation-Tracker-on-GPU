...
namespace magmaHCWrapper {
        ...
        const magmaFloatComplex __restrict__ *d_phc_coeffs_Ht )
    {
        ...
        // -- 36 - 11*3 = 3 --
        // -- N_2 * 3 = 66 --
        // -- last s_phc_coeffs_Hx from the above for-loop: 11*3 = 33
        if (tx < 3) {
          s_phc_coeffs_Hx[ tx + 33 ] = d_phc_coeffs_Hx[ tx*2 + 66] 
                                     + d_phc_coeffs_Hx[ tx*2 + 1 + 66] * t;
        }
        ...
        // -- 36 - 11*3 = 3 --
        // -- N * 3 = 33 --
        // -- last s_phc_coeffs_Ht from the above for-loop: 11*3 = 33
        if (tx < 3) {
