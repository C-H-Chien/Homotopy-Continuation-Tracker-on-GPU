...
namespace magmaHCWrapper {
  ...
  )
  {
    ...
    h_phc_coeffs_H[6]=q3;
    h_phc_coeffs_H[7]=p3 - q3;
    h_phc_coeffs_H[8]=-2*q28;
    h_phc_coeffs_H[9]=2*q28 - 2*p28;
    h_phc_coeffs_H[10]=q4;
    h_phc_coeffs_H[11]=p4 - q4;
    h_phc_coeffs_H[12]=q5;
    h_phc_coeffs_H[13]=p5 - q5;
    h_phc_coeffs_H[14]=q6;
    h_phc_coeffs_H[15]=p6 - q6;
    h_phc_coeffs_H[16]=-2*q29;
    h_phc_coeffs_H[17]=2*q29 - 2*p29;
    h_phc_coeffs_H[18]=q10;
    h_phc_coeffs_H[19]=p10 - q10;
    h_phc_coeffs_H[20]=q11;
    h_phc_coeffs_H[21]=p11 - q11;
    h_phc_coeffs_H[22]=q7;
    h_phc_coeffs_H[23]=p7 - q7;
    h_phc_coeffs_H[24]=q12;
    h_phc_coeffs_H[25]=p12 - q12;
    h_phc_coeffs_H[26]=-2*q30;
    h_phc_coeffs_H[27]=2*q30 - 2*p30;
    h_phc_coeffs_H[28]=q13;
    h_phc_coeffs_H[29]=p13 - q13;
    h_phc_coeffs_H[30]=q14;
    h_phc_coeffs_H[31]=p14 - q14;
    h_phc_coeffs_H[32]=q8;
    h_phc_coeffs_H[33]=p8 - q8;
    h_phc_coeffs_H[34]=q15;
    h_phc_coeffs_H[35]=p15 - q15;
    h_phc_coeffs_H[36]=-2*q31;
    h_phc_coeffs_H[37]=2*q31 - 2*p31;
    h_phc_coeffs_H[38]=q19;
    h_phc_coeffs_H[39]=p19 - q19;
    h_phc_coeffs_H[40]=q20;
    h_phc_coeffs_H[41]=p20 - q20;
    h_phc_coeffs_H[42]=q16;
    h_phc_coeffs_H[43]=p16 - q16;
    h_phc_coeffs_H[44]=q21;
    h_phc_coeffs_H[45]=p21 - q21;
    h_phc_coeffs_H[46]=-2*q32;
    h_phc_coeffs_H[47]=2*q32 - 2*p32;
    h_phc_coeffs_H[48]=q22;
    h_phc_coeffs_H[49]=p22 - q22;
    h_phc_coeffs_H[50]=q23;
    h_phc_coeffs_H[51]=p23 - q23;
    h_phc_coeffs_H[52]=q17;
    h_phc_coeffs_H[53]=p17 - q17;
    h_phc_coeffs_H[54]=q24;
    h_phc_coeffs_H[55]=p24 - q24;
    h_phc_coeffs_H[56]=-2*q33;
    h_phc_coeffs_H[57]=2*q33 - 2*p33;
    h_phc_coeffs_H[58]=q25;
    h_phc_coeffs_H[59]=p25 - q25;
    h_phc_coeffs_H[60]=-2*q34;
    h_phc_coeffs_H[61]=2*q34 - 2*p34;
    h_phc_coeffs_H[62]=q26;
    h_phc_coeffs_H[63]=p26 - q26;
    h_phc_coeffs_H[64]=-2*q35;
    h_phc_coeffs_H[65]=2*q35 - 2*p35;
    h_phc_coeffs_H[66]=q9;
    h_phc_coeffs_H[67]=p9 - q9;
    h_phc_coeffs_H[68]=q18;
    h_phc_coeffs_H[69]=p18 - q18;
    h_phc_coeffs_H[70]=q27;
    h_phc_coeffs_H[71]=p27 - q27;

    h_phc_coeffs_Ht[0]= MAGMA_C_ZERO;
    h_phc_coeffs_Ht[1]=p1 - q1;
    h_phc_coeffs_Ht[2]=p2 - q2;
    h_phc_coeffs_Ht[3]=p3 - q3;
    h_phc_coeffs_Ht[4]=2*q28 - 2*p28;
    h_phc_coeffs_Ht[5]=p4 - q4;
    h_phc_coeffs_Ht[6]=p5 - q5;
    h_phc_coeffs_Ht[7]=p6 - q6;
    h_phc_coeffs_Ht[8]=2*q29 - 2*p29;
    h_phc_coeffs_Ht[9]=p10 - q10;
    h_phc_coeffs_Ht[10]=p11 - q11;
    h_phc_coeffs_Ht[11]=p7 - q7;
    h_phc_coeffs_Ht[12]=p12 - q12;
    h_phc_coeffs_Ht[13]=2*q30 - 2*p30;
    h_phc_coeffs_Ht[14]=p13 - q13;
    h_phc_coeffs_Ht[15]=p14 - q14;
    h_phc_coeffs_Ht[16]=p8 - q8;
    h_phc_coeffs_Ht[17]=p15 - q15;
    h_phc_coeffs_Ht[18]=2*q31 - 2*p31;
    h_phc_coeffs_Ht[19]=p19 - q19;
    h_phc_coeffs_Ht[20]=p20 - q20;
    h_phc_coeffs_Ht[21]=p16 - q16;
    h_phc_coeffs_Ht[22]=p21 - q21;
    h_phc_coeffs_Ht[23]=2*q32 - 2*p32;
    h_phc_coeffs_Ht[24]=p22 - q22;
    h_phc_coeffs_Ht[25]=p23 - q23;
    h_phc_coeffs_Ht[26]=p17 - q17;
    h_phc_coeffs_Ht[27]=p24 - q24;
    h_phc_coeffs_Ht[28]=2*q33 - 2*p33;
    h_phc_coeffs_Ht[29]=p25 - q25;
    h_phc_coeffs_Ht[30]=2*q34 - 2*p34;
    h_phc_coeffs_Ht[31]=p26 - q26;
    h_phc_coeffs_Ht[32]=2*q35 - 2*p35;
    h_phc_coeffs_Ht[33]=p9 - q9;
    h_phc_coeffs_Ht[34]=p18 - q18;
    h_phc_coeffs_Ht[35]=p27 - q27;
  }
} // end of namespace
