#ifndef DEV_EVAL_INDXING_UNCALIBRATED_TRIFOCAL_REL_POS_CY_CUH
#define DEV_EVAL_INDXING_UNCALIBRATED_TRIFOCAL_REL_POS_CY_CUH
// =================================================================================================
// Device function for evaluating the Jacobians ∂H/∂x, ∂H/∂t, and H
//
// Modifications
//    Chiang-Heng Chien  24-05-26:   Build on top of generalized three-view relative pose problem.
//
// =================================================================================================
#include <cstdio>
#include <iostream>
