#ifndef dev_eval_indxing_trifocal_2op1p_30_8b_SM_LIMUNROLL_CUH
#define dev_eval_indxing_trifocal_2op1p_30_8b_SM_LIMUNROLL_CUH
// ===============================================================================================
...
eval_Jacobian_Hx(
    ...
    char              dHdx_indices[dHdx_Index_Matrix_Size]
)
{
...
eval_Jacobian_Ht(
    ...
    magmaFloatComplex *s_target_params,   //> target parameters
    magmaFloatComplex *s_param_homotopy,  //> parameter homotopy
    char              dHdt_indices[dHdt_Index_Matrix_Size],
