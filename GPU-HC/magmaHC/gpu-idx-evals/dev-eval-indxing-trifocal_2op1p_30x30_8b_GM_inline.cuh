#ifndef dev_eval_indxing_trifocal_2op1p_30_8b_GM_INLINE_cuh_
#define dev_eval_indxing_trifocal_2op1p_30_8b_GM_INLINE_cuh_
// ===============================================================================================
...
eval_Jacobian_Hx(
    ...
    const char* __restrict__ dHdx_indices            //> indices for the Jacobian Hx matrix
)
{
...
eval_Jacobian_Ht(
    ...
    magmaFloatComplex *s_target_params,   //> target parameters
    magmaFloatComplex *s_param_homotopy,  //> parameter homotopy
    const char* __restrict__ dHdt_indices,  //> indices for the Jacobian Hx matrix
...
eval_Homotopy(
    ...
    magmaFloatComplex *s_target_params,   //> target parameters
    magmaFloatComplex *s_param_homotopy,  //> parameter homotopy
    const char* __restrict__ dHdt_indices  //> indices for the Jacobian Ht matrix
)
{
  //> initialize each element to 0
  r_cgesvB = MAGMA_C_ZERO;
