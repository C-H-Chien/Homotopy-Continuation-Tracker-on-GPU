#ifndef DEV_EVAL_INDXING_P3P_10x10_CUH
#define DEV_EVAL_INDXING_P3P_10x10_CUH
// =================================================================================================
// Device function for evaluating the Jacobians ∂H/∂x, ∂H/∂t, and H
//
// Modifications
//    Chiang-Heng Chien  25-01-19:   BUild on top of P3P dev-eval-indxing-P3P
//
// =================================================================================================
#include <cstdio>
#include <iostream>
    ...
    const magmaFloatComplex __restrict__ *d_phc_coeffs_Ht )
{
  #pragma unroll 2
	 ...
	 if (tx < Partial_Parallel_Thread_Offset) {
	   s_phc_coeffs_Hx[ tx + Partial_Parallel_Index_Offset ] = d_phc_coeffs_Hx[ tx*Max_Order_of_t_Plus_One + Partial_Parallel_Index_Offset_Hx ]
		                                                       + d_phc_coeffs_Hx[ tx*Max_Order_of_t_Plus_One + Partial_Parallel_Index_Offset_Hx +1 ] * t;
	   s_phc_coeffs_Ht[ tx + Partial_Parallel_Index_Offset ] = d_phc_coeffs_Ht[ tx*Max_Order_of_t + Partial_Parallel_Index_Offset_Ht ];
	}
}
