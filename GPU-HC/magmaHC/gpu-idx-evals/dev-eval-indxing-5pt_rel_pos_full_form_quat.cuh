#ifndef DEV_EVAL_INDXING_5PT_REL_POS_FULL_FORM_QUAT_CUH
#define DEV_EVAL_INDXING_5PT_REL_POS_FULL_FORM_QUAT_CUH
// =================================================================================================
    ...
    const magmaFloatComplex __restrict__ *d_phc_coeffs_Hx )
{
  ...
  //> parameter homotopy for evaluating ∂H/∂x and ∂H/∂t
    s_phc_coeffs_Hx[ tx ] = d_phc_coeffs_Hx[ tx*Max_Order_of_t_Plus_One  ] 
                          + d_phc_coeffs_Hx[ tx*Max_Order_of_t_Plus_One + 1 ] * t;
