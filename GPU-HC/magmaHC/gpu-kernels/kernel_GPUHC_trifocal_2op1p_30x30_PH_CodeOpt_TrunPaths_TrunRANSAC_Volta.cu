#ifndef kernel_GPUHC_trifocal_2op1p_30x30_PH_CODEOPT_TRUNPATHS_TRUNRANSAC_VOLTA_cu
#define kernel_GPUHC_trifocal_2op1p_30x30_PH_CODEOPT_TRUNPATHS_TRUNRANSAC_VOLTA_cu
// ===========================================================================================
...
__global__ void
kernel_GPUHC_trifocal_pose_PH_CodeOpt_TrunPaths_TrunRANSAC_Volta(
...
real_Double_t
kernel_GPUHC_trifocal_2op1p_30x30_PH_CodeOpt_TrunPaths_TrunRANSAC_Volta(
...
)
{
  ...
  if (shmem <= shmem_max) {
    cudacheck( cudaFuncSetAttribute(kernel_GPUHC_trifocal_pose_PH_CodeOpt_TrunPaths_TrunRANSAC_Volta \
  ...
  e = cudaLaunchKernel((void*)kernel_GPUHC_trifocal_pose_PH_CodeOpt_TrunPaths_TrunRANSAC_Volta \
                        <num_of_vars, num_of_params, \
                         dHdx_Max_Terms, dHdx_Max_Parts, dHdx_Entry_Offset, dHdt_Max_Terms, dHdt_Max_Parts, \
                         dHdx_Index_Matrix_Size, dHdt_Index_Matrix_Size >, // dHdx_Num_Of_Read_Loops, dHdt_Num_Of_Read_Loops >,
  ...
  if( e != cudaSuccess ) printf("cudaLaunchKernel of kernel_GPUHC_trifocal_pose_PH_CodeOpt_TrunPaths_TrunRANSAC_Volta is not successful!\n");
