#ifndef kernel_HC_Solver_trifocal_2op1p_30x30_PH_cu
#define kernel_HC_Solver_trifocal_2op1p_30x30_PH_cu
// ===========================================================================================
...
real_Double_t
kernel_GPUHC_trifocal_2op1p_30x30_PH(
...
)
{
  ...
  if (shmem <= shmem_max) {
    cudacheck( cudaFuncSetAttribute(kernel_GPUHC_trifocal_pose_PH \
  ...
  e = cudaLaunchKernel((void*)kernel_GPUHC_trifocal_pose_PH \
                        <num_of_vars, num_of_params, \
                         dHdx_Max_Terms, dHdx_Max_Parts, dHdx_Entry_Offset, dHdt_Max_Terms, dHdt_Max_Parts, \
                         dHdx_Index_Matrix_Size, dHdt_Index_Matrix_Size >, \
  ...
  if( e != cudaSuccess ) printf("cudaLaunchKernel of kernel_GPUHC_trifocal_pose_PH is not successful!\n");
