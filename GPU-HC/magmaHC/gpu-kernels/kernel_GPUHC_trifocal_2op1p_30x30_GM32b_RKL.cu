#ifndef kernel_GPUHC_trifocal_2op1p_30x30_GM32b_RKL_cu
#define kernel_GPUHC_trifocal_2op1p_30x30_GM32b_RKL_cu
// ===========================================================================================
...
__global__ void
kernel_GPUHC_trifocal_rel_pos_GM32b_RKL(
...
real_Double_t
kernel_GPUHC_trifocal_2op1p_30x30_GM32b_RKL(
...
)
{
  ...
  if (shmem <= shmem_max) {
    cudacheck( cudaFuncSetAttribute(kernel_GPUHC_trifocal_rel_pos_GM32b_RKL \
  ...
  e = cudaLaunchKernel((void*)kernel_GPUHC_trifocal_rel_pos_GM32b_RKL \
                        <num_of_vars, num_of_params, \
                         dHdx_Max_Terms, dHdx_Max_Parts, dHdx_Entry_Offset, dHdt_Max_Terms, dHdt_Max_Parts, \
                         dHdx_Index_Matrix_Size, dHdt_Index_Matrix_Size >, // dHdx_Num_Of_Read_Loops, dHdt_Num_Of_Read_Loops >,
  ...
  if( e != cudaSuccess ) printf("cudaLaunchKernel of kernel_GPUHC_trifocal_rel_pos_GM32b_RKL is not successful!\n");
