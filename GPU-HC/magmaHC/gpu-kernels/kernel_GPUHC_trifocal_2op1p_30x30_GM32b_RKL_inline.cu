#ifndef kernel_GPUHC_trifocal_2op1p_30x30_GM32b_RKL_inline_cu
#define kernel_GPUHC_trifocal_2op1p_30x30_GM32b_RKL_inline_cu
// ===========================================================================================
...
//> device functions
#include "../gpu-idx-evals/dev-eval-indxing-trifocal_2op1p_30x30_32b_inline.cuh"
...
__global__ void
kernel_GPUHC_trifocal_rel_pos_GM32b_RKL_inline(
...
real_Double_t
kernel_GPUHC_trifocal_2op1p_30x30_GM32b_RKL_inline(
...
)
{
  ...
  if (shmem <= shmem_max) {
    cudacheck( cudaFuncSetAttribute(kernel_GPUHC_trifocal_rel_pos_GM32b_RKL_inline \
  ...
  e = cudaLaunchKernel((void*)kernel_GPUHC_trifocal_rel_pos_GM32b_RKL_inline \
                        <num_of_vars, num_of_params, \
                         dHdx_Max_Terms, dHdx_Max_Parts, dHdx_Entry_Offset, dHdt_Max_Terms, dHdt_Max_Parts, \
                         dHdx_Index_Matrix_Size, dHdt_Index_Matrix_Size >, // dHdx_Num_Of_Read_Loops, dHdt_Num_Of_Read_Loops >,
  ...
  if( e != cudaSuccess ) printf("cudaLaunchKernel of kernel_GPUHC_trifocal_rel_pos_GM32b_RKL_inline is not successful!\n");
