#ifndef KERNEL_HC_solver_3PT_REL_POS_HOMOG_CU
#define KERNEL_HC_solver_3PT_REL_POS_HOMOG_CU
// =============================================================================================================
// GPU homotopy continuation solver for Homography Constrained 3-Point Relative Pose Estimation Problem
//
// Modifications
...
//> device functions
#include "../gpu-idx-evals/dev-eval-indxing-3pt_rel_pos_homog.cuh"
...
real_Double_t
kernel_HC_Solver_3pt_rel_pos_homog(
...
)
{
  ...
  const int num_of_coeffs_from_params = 27;
  ...
  if (shmem <= shmem_max) {
    cudacheck( cudaFuncSetAttribute(HC_solver_3pt_rel_pos_homog \
  ...
  e = cudaLaunchKernel((void*)HC_solver_3pt_rel_pos_homog \
                        < num_of_vars, num_of_coeffs_from_params, max_order_of_t, \
                          dHdx_Max_Terms, dHdx_Max_Parts, dHdx_Entry_Offset, dHdx_Row_Offset, \
                          dHdt_Max_Terms, dHdt_Max_Parts, dHdt_Row_Offset, \
                          Full_Parallel_Offset, \
  ...
  if( e != cudaSuccess ) printf("cudaLaunchKernel of HC_solver_3pt_rel_pos_homog is not successful!\n");
