...
namespace magmaHCWrapper {
  ...
  )
  {
    ...
    e = cudaLaunchKernel((void*)homotopy_continuation_solver_5pt_rel_pos_alg_form_quat< 6, 76, 42, 4, 5, 12, 4, 30, 5 >, grid, threads, kernel_args, shmem, my_queue->cuda_stream());
